...
<body>
    ...
    <div class=" container px-4 py-5 my-5 text-center">
        <div class=" col-md-10 mx-auto col-lg-5">
            <form action="{{route('user.register')}}" method="post" class="p-4 p-md-5 border rounded-3 bg-body-tertiary">
                @csrf
                <div class="form-floating mb-3">
                    <input name="nama_pengguna" type="text" class="form-control" id="floatingInput" placeholder="name@example.com">
                ...
                <hr class="my-4">
                <small class="text-body-secondary">sudah punya akun? <a href="{{route('page.login')}}">login</a></small>
            </form>
        </div>
    </div>
